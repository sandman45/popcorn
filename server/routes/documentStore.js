...
module.exports = function( app ){
  ...
  app.post('/popcorn/uploadDocument', upload.single('file'), function( req, res, next ){
    var file = req.file;
    var content;
  ...
  app.get('/popcorn/getUserDocuments/:userid', function( req, res, next ){
  ...
  app.get('/popcorn/getChallengeDocuments/:challengeid', function( req, res, next ){
  ...
  app.get('/popcorn/getUserChallengeDocuments/:userid/:challengeid', function( req, res, next ){
    var challengeid = req.params.challengeid;
    var userid = req.params.userid;
